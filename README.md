...
I developed this AI-powered Fake News Detection system as a complementary module for my News Aggregator App. The goal is to integrate this feature into the aggregator, enabling it to automatically analyze and label each displayed news article as real or fake in real time — helping users quickly identify credible information.
